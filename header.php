...
if ( file_exists(XOOPS_ROOT_PATH."/modules/friendfinder/language/".$xoopsConfig['language']."/main.php") ) {
        include(XOOPS_ROOT_PATH."/modules/friendfinder/language/".$xoopsConfig['language']."/main.php");
}else{
        include(XOOPS_ROOT_PATH."/modules/friendfinder/language/english/main.php");
}
?>
