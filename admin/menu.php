...
#################################################################################
$adminmenu[0]['title'] = _menu;
$adminmenu[0]['link'] = "admin/index.php";
$adminmenu[2]['title'] = _menu1;
$adminmenu[2]['link'] = "admin/view-all.php";
$adminmenu[1]['title'] =_menu2;
$adminmenu[1]['link'] ="admin/pref.php";
$adminmenu[3]['title'] = _menu3;
$adminmenu[3]['link'] ="admin/select.php";
$adminmenu[4]['title'] = _MANUAL;
$adminmenu[4]['link'] ="admin/manual.php";
