...
$sql = "SELECT * FROM ".$xoopsDB->prefix("friendfinder")." where active=1 ";
...
OpenTable();
echo"<TABLE BORDER=0 width=100% align=\"left\" CELLPADDING=0 CELLSPACING=0><h5>Last 5 Profiles Posted</h><TR>
<td>";
     if (!$start)
         {
         $start = "0";
...
<td rowspan=14><img src=".$myts->makeTboxData4Show($picture)." border=0 width=50></td></TR>
...
<TR><TD>"._TEXTCATEGORY."</TD><TD>".$cattitle."</TD></TR>
</TD></TR></TABLE>";
CloseTable();
}
