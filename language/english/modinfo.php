...
#################################################################################
// Module Info
 define("_menu","Overview");
 define("_menu1","Show profiles");
 define("_menu2","Main configuration");
 define("_menu3","Preferences");


// Module name
define("_XFF","Friendfinder");
define("_XFF_SUBMENU","Submit your profile");
define("_XFF_SUBMENUSEARCH","Search for a profile");
// Module Description
define("_XFF_DESC","Xoops Friendfinder for rc3");


//Blocks
define("_FRIENDFINDERBLOCK","Friendfinder block for random profiles");
define("_FRIENDFINDERQSBLOCK","Friendfinder quick search block");
