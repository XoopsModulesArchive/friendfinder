...
#################################################################################
// Module Info
 define("_menu","Panorama");
 define("_menu1","Le denunce guardano");
 define("_menu2","Configurazione generale");
 define("_menu3","Collocazioni");
// Module name
define("_XFF","Friendfinder");
define("_XFF_SUBMENU","La denuncia spediscono");
define("_XFF_SUBMENUSEARCH","La denuncia cercano");

// Module Description
define("_XFF_DESC","Xoops Friendfinder");

//Blocks
define("_FRIENDFINDERBLOCK","Friendfinder blocca per denuncia di profilo casuale");
?>
